...
//		//part 2
//		ArrayList<FoodItem> lowCalorieFoods = cc.getAllLowCalorieFoods();		
//		System.out.println(lowCalorieFoods);
//		
//		for(FoodItem fi : lowCalorieFoods) {
//			
//			//looping through the list of food items, need to check instance of
//			
//			if (fi instanceof ReadyMeal) {
//				//downcast
//				ReadyMeal rm = (ReadyMeal)fi;
//				System.out.println(rm.getName() + ", $" +  rm.getPrice() + ", " + rm.getCuisineType() + " cuisine.");
//			}
//			
//			else if (fi instanceof Snack) {
//				Snack s = (Snack)fi;
//				System.out.println(s.getName() + ", $" + s.getPrice() + ", Fat Content: " + s.getFatContent() + ", Sugar Content: " + s.getSugarContent());
//			} else {
...
//		}
		...
		//part 3
		System.out.println(b.getAllItems());
		cc.removeHighCalorieFoodsFromBasket(b,500);
		System.out.println("after remove: " + b.getAllItems());
